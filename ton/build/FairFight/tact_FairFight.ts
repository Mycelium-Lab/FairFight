...
export function storeFight(src: Fight) {
    return (builder: Builder) => {
        ...
        b_2.storeCoins(src.escrowed);
        b_2.storeCoins(src.paidOut);
...
export function loadFight(slice: Slice) {
    ...
    let _escrowed = sc_2.loadCoins();
    let _paidOut = sc_2.loadCoins();
    return { $$type: 'Fight' as const, id: _id, owner: _owner, createTime: _createTime, finishTime: _finishTime, baseAmount: _baseAmount, amountPerRound: _amountPerRound, rounds: _rounds, maxPlayersAmount: _maxPlayersAmount, players: _players, playersCurrentLength: _playersCurrentLength, playersClaimed: _playersClaimed, escrowed: _escrowed, paidOut: _paidOut };
}
...
function loadTupleFight(source: TupleReader) {
    ...
    let _escrowed = source.readBigNumber();
    let _paidOut = source.readBigNumber();
    return { $$type: 'Fight' as const, id: _id, owner: _owner, createTime: _createTime, finishTime: _finishTime, baseAmount: _baseAmount, amountPerRound: _amountPerRound, rounds: _rounds, maxPlayersAmount: _maxPlayersAmount, players: _players, playersCurrentLength: _playersCurrentLength, playersClaimed: _playersClaimed, escrowed: _escrowed, paidOut: _paidOut };
}
...
function storeTupleFight(source: Fight) {
    ...
    builder.writeNumber(source.escrowed);
    builder.writeNumber(source.paidOut);
    return builder.build();
}
...
async function FairFight_init(owner: Address, signerPublicKey: bigint, feeCollector: Address, fee: bigint, maxPlayers: bigint, maxRounds: bigint, minAmountPerRound: bigint) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const FairFight_errors: { [key: number]: { message: string } } = {
    ...
    8040: { message: `signed address does not match sender` },
    9617: { message: `sender is not a participant` },
    13244: { message: `value does not equal sum to play` },
    15880: { message: `fight has players` },
    16679: { message: `fee out of range` },
    23915: { message: `fight escrow exceeded` },
...
const FairFight_types: ABIType[] = [
    ...
    {"name":"Fight","header":null,"fields":[{"name":"id","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"createTime","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"finishTime","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"baseAmount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"amountPerRound","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"rounds","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"maxPlayersAmount","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"players","type":{"kind":"dict","key":"int","value":"address"}},{"name":"playersCurrentLength","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"playersClaimed","type":{"kind":"dict","key":"address","value":"bool"}},{"name":"escrowed","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"paidOut","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
