...
// The chain registry used to be duplicated here and in lib/modules/networks.js,
// and the two had drifted. Both now re-export one source: shared/networks.js for
// the browser-safe shape, shared/networks.server.js for the same list plus the
// server-only `rpc` and `privateKey`.
export { networks } from '../shared/networks.server.js'
