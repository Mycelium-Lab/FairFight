...
imageCharacter.id = 'image-character'

let imageRivalCharacter = document.createElement("img")
imageRivalCharacter.style.display = 'none'
imageRivalCharacter.id = 'image-rival-character'

const body = document.querySelector('body')
body.append(imageCharacter, imageRivalCharacter)
