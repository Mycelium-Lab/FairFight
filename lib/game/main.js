...
// let imageCharacterUrl
// let imageRivalCharacterUrl
// if (navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) {
//   imageCharacterUrl = window.webkitURL.createObjectURL(player1Image);
//   imageRivalCharacterUrl = window.webkitURL.createObjectURL(player2Image)
// } else {
//   imageCharacterUrl = window.URL.createObjectURL(player1Image);
//   imageRivalCharacterUrl = window.URL.createObjectURL(player2Image)
// }
let imageCharacter = new Image()
let imageRivalCharacter = new Image()

let isImageCharacterLoaded = true;
let isImageRivalCharacterLoaded = true;
...
//       // Начать загрузку второго изображения после загрузки первого
//       reader.onload = function(event) {
