...
MyGame = ig.Game.extend({
  ...
  arrowSheet: new ig.AnimationSheet('../media/sprites/arrow.png', 32, 32),
  ...
  drawArrow: function() {
    // arrow = new ig.Animation( this.arrowSheet, 0.1, [0] ),
...
GameRoom = ig.Class.extend({
  ...
  onJoinedRoom: function(roomInfo) {
    ...
    ig.main('#canvas', MyGame, 60, 510, 385, 3);
    // ig.main('#canvas', MyGame, 60, 1020, 770, 3);
  },
