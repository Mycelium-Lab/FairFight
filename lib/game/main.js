...
const Maps = [
  {
    ...
    x: 1025,
    y: 770,
    mapSizeCameraReduceX: 4,
    mapSizeCameraReducey: 3, 
    trapSizeRatio: 5,
    trapSizeReduceX: 20,
    trapSizeReduceY: 6,
    minimap: {x: 210, y: 200}
  },
  {
    ...
    x: 2046,
    y: 770,
    mapSizeCameraReduceX: 6.5,
    mapSizeCameraReducey: 5, 
    trapSizeRatio: 3,
    trapSizeReduceX: 40,
    trapSizeReduceY: 12,
    minimap: {x: 400, y: 200}
  ...
  if (isImageCharacterLoaded && isImageRivalCharacterLoaded) {
    let MyGame = ig.Game.extend({
      ...
      init: function() {
        ...
        this.camera = new Camera(
          ig.system.width / chosenMap.mapSizeCameraReduceX, 
          ig.system.height / chosenMap.mapSizeCameraReducey, 
          chosenMap.trapSizeRatio
        );
        this.camera.trap.size.x = ig.system.width / chosenMap.trapSizeReduceX;
        this.camera.trap.size.y = ig.system.height / chosenMap.trapSizeReduceY;
    ...
    let GameRoom = ig.Class.extend({
      ...
      onJoinedRoom: function(roomInfo) {
        ...
        ig.main('#canvas', MyGame, 60, chosenMap.x, chosenMap.y, ig.ua.mobile ? 0.5 : 3);
      },
