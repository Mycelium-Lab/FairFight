...
JoyStick.prototype.__create_fullscreen_div = function()
{
	...
	//JOYSTICK_DIV.style.left = '-' + Number(parseInt(div_style.left) + 13) + 'px'
	...
	function touch_hander( evt )
	{
		...
		self.control.style.left = joystickBaseX - self.inner_radius + offsetX + 'px';
        self.control.style.top = joystickBaseY - self.inner_radius + offsetY + 'px';
