...
export var JoyStick = function( attrs ) {
    ...
    this.maxOffsetX = this.radius; // Максимальное смещение по горизонтали
    this.maxOffsetY = this.radius; // Максимальное смещение по вертикали
...
JoyStick.prototype.__create_fullscreen_div = function()
{
	...
	function touch_hander( evt )
	{
        ...
        var offsetX = touch_obj.clientX - self.x;
        var offsetY = touch_obj.clientY - self.y;
