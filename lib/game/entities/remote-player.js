    ...
    update: function() {
      if (this.stateUpdated) {
        ...
        if (this.newTime > this.prevTime) {
          ...
          // this.pos.x = this.prevPos.x + (this.newPos.x - this.prevPos.x) * progress * this.velocity.x;
          // this.pos.y = this.prevPos.y + (this.newPos.y - this.prevPos.y) * progress * this.velocity.y;
        }
        if (this.currentAnim) {
