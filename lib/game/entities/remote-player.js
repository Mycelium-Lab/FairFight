...
.defines(function() {
  EntityRemotePlayer = ig.Entity.extend({
    ...
    RcvNewLocation: function(rcvedLocation) {
        ...
        if (
          (Math.floor(this.locationOld.x) == Math.floor(this.locationNew.x) && Math.floor(this.locationOld.y) == Math.floor(this.locationNew.y))
          ||
    ...
    UpdateLocation: function(deltaTime) {
      if (Math.floor(this.locationOld.x) == Math.floor(this.locationNew.x) && Math.floor(this.locationOld.y) == Math.floor(this.locationNew.y)) {
        this.locationOld = this.locationNew;
