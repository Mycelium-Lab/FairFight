...
.defines(function() {
  EntityRemotePlayer = ig.Entity.extend({
    ...
    init: function(x, y, settings) {
      ...
      let player2Img = localStorage.getItem('player2image') === null ? '../media/sprites/characters/Player2.png' : localStorage.getItem('player2image') 
      this.animSheet = new ig.AnimationSheet(player2Img, 32, 32);
      this.friction.y = 0;
