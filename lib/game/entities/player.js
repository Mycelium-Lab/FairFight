...
ig.module(
  ...
  EntityPlayer = ig.Entity.extend({
    ...
    init: function(x, y, settings) {
      ...
      // this.animSheet = new ig.AnimationSheet('../media/sprites/11111.svg', 16, 16);
      // this.animSheet = new ig.AnimationSheet('../media/sprites/player-red.png', 32, 32);
      this.friction.y = 0;
      ...
      this.addAnim('run', 0.07, [18, 20, 22, 24, 26]);
