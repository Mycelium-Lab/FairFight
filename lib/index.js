    ...
    //   }
      ...
      amountToPlay.addEventListener('input', () => {
        if (amountToPlay.value != '' && amountPerDeath.value != '') {
          totalPrizePool.textContent = Math.floor(parseFloat(amountPerDeath.value) * parseFloat(amountToPlay.value) * 2)
          yourDeposit.textContent = Math.floor(parseFloat(amountPerDeath.value) * parseFloat(amountToPlay.value))
        } else {
      ...
      document
        ...
        .addEventListener("click", async function () {
          ...
          try {
            ...
            console.log(BigInt(Math.round(amountPerDeathValue)).toString(), BigInt(Math.round(amountToPlayValue)).toString())
