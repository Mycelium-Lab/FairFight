...
document.querySelector("#about_modal").onclick = e => {
    if (e.target.classList.contains("modal")) {
        ...
        thirdContentTitle.style.display = "none";
    }
};
document.querySelector(".close_modal_window").onclick = e => {
    document.querySelector("#about_modal").style.display = "none";
...
let thirdContent = document.querySelector(".about__content_control_keys"),
    thirdContentTitle = document.querySelector(".controls_outer_title");
...
secondButton.onclick = () => {
    ...
    thirdContentTitle.style.display = "block";
}
