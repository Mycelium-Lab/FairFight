    ...
    TONChannel = function(walletAddress, publicKey,isA) {
        ...
        this.myWallet.getAddress().then((r) => {
            ...
            theirWallet.getAddress().then((r) => {
                ...
                this.channelConfig = {
                    channelId: new BN(getRandomInt(0,10000000)),
    ...
    TONChannel.prototype = {
        init: async function(isA) {
            ...
            try {
                ...
                if (isA)
                    this.r = await fromWallet.init(this.channelInitState).send(toNano('0.05'));
                ...
                console.log('Last Channel balance A: ', data.balanceA.toString());
                console.log('Last Channel balance B: ', data.balanceB.toString());
