...
function toggleInventoryModal() {
  const inventoryModalOverlay = document.querySelector('.wrapper__inventory-modal-overlay')
  inventoryModalOverlay.classList.toggle('wrapper__inventory-modal-overlay_active')

  if (inventoryModalOverlay.classList.contains('wrapper__inventory-modal-overlay_active')) {
    document.body.style.overflow = 'hidden'
  }
  else {
    document.body.style.overflow = 'auto'
