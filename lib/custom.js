...
window.addEventListener('load', () => {
  ...
  btnOpenShop.addEventListener('click', toggleNftShopModal)
  btnOpenNftShop.addEventListener('click', toggleNftShopModal)
  btnOpenNftShopMobile.addEventListener('click', toggleNftShopModal)
  const btnOpenCharactersModalShop = document.querySelector('#new-characters-btn')
  const btnOpenTryLuckModalShop = document.querySelector('#try-luck-btn')
  ...
  btnOpenCharactersModalShop.addEventListener('click', () => {
    toggleNftShopModal()
  ...
  btnOpenTryLuckModalShop.addEventListener('click', () => {
    toggleNftShopModal()
  ...
  inventoryBtnOpenTon.addEventListener('click', toggleInventoryModal)
