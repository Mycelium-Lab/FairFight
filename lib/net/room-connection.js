...
RoomConnection = Events.Emitter.extend({
  ...
  initPaymentChannel: function(walletAddress, publicKey) {
    return new TONChannel(walletAddress, publicKey);
  },
  ...
  onJoinedRoom: function(roomInfo) {
    ...
    for (var k in this.roomInfo.users) {
      ...
      if (user.userId !== this.roomInfo.userId) {
        ...
        this.paymentChannel = this.initPaymentChannel(user.walletAddress, user.publicKey);
      }
    }
  ...
  onUserJoin: function(user) {
    ...
    this.paymentChannel = this.initPaymentChannel(user.user.walletAddress, user.user.publicKey);
  },
