...
$(document).ready(async function () {
    try {
        ...
        if (isMobile) {
            ...
            const showMap = document.querySelector('#map_ton_btn')
        ...
        try {
            ...
            const closePauseModal = document.querySelector('#close_pause_modal')
        ...
        try {
            document.querySelector('#open_control_keys').addEventListener('click', () => {
                document.querySelector('#control_keys_mobile_modal').style.display = 'flex'
            })
            document.querySelector('#close_control_keys_mobile_modal').addEventListener('click', () => {
                document.querySelector('#control_keys_mobile_modal').style.display = 'none'
            })
        } catch (error) {}
    } catch (error) {
        console.log(error)
