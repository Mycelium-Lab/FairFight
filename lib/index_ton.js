...
// Was hardcoded here and, separately, in server/ton/service.js. Both agreed;
// the registry is now the one place it lives.
const tonNetwork = findNetwork(0)
const contractAddressTest = tonNetwork.contractAddress
const contractAddress = tonNetwork.contractAddress
const isTest = false
