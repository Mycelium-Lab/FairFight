...
const main = async () => {
    console.log(window.Telegram.WebApp, window.Telegram.WebApp.WebAppUser)
    ...
    btnMobile.textContent = window.Telegram.WebApp.WebAppUser ? `${window.Telegram.WebApp.WebAppUser.id} ${window.Telegram.WebApp.WebAppUser.username}` : 'Ne'
