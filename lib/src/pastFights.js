...
pastgamesBtn.addEventListener('click', () => {
    ...
    const pastGamesList = document.getElementById('pastgames-list').querySelector('.simplebar-content')
...
export const addToPastFights = async (fight, network, signer, address, from, isInfoModal) => {
    ...
    let pastGamesList = document.getElementById('pastgames-list').querySelector('.simplebar-content')
