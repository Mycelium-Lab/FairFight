...
export const addWalletToLocalStorage = (account, wallet_type, walletconnect_data) => {
  localStorage.setItem('account', account)
  localStorage.setItem('wallet_type', wallet_type)
  localStorage.setItem('walletconnect_data', walletconnect_data)
}

export const removeWalletFromLocalStorage = () => {
  localStorage.removeItem('account')
  localStorage.removeItem('wallet_type')
  localStorage.removeItem('walletconnect_data')
}