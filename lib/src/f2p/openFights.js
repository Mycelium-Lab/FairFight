...
const appendOpenFight = async (fight, username, tgInitData) => {
    ...
    if (buttonText === BUTTON_TEXT.WITHDRAW) {
        ...
        hrefParams.append('text', `@${username} invite you to play fairfights f2p game (id: ${index})`)
        link.href = `https://t.me/share/url?url=https://t.me/fairfights_bot?startapp&${hrefParams.toString()}`
