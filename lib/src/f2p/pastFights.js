...
export const pastFightsF2P = async (pastFights, username) => {    
    ...
    let pastgames = document.getElementById("pastgames-f2p")
    let pastGamesSimpleBar = document.getElementById('pastgames-list-f2p')
    ...
    if (pastGamesList.length === 1) {
      document.getElementById("pastgames_empty-f2p").style.display = ''
      pastgames.classList.add("empty")
    }
    else {
        document.getElementById("pastgames_empty-f2p").style.display = 'none'
        pastgames.classList.remove("empty")
        // pastgames.appendChild(pastGamesList)
      }
}

const pastgamesBtn = document.querySelector('#pastgames-f2p-btn')
pastgamesBtn.addEventListener('click', () => {
    const pastGamesList = document.getElementById('pastgames-list-f2p')
    const pastgames = document.getElementById("pastgames-f2p")
...
export const addToPastFights = async (fight, username, isInfoModal, from) => {
    ...
    let pastGamesList = document.getElementById('pastgames-list-f2p')
