...
const buyButton = isDesktop ? document.querySelector('#lootbox-buy-btn') : document.querySelector('#lootbox-buy-btn-mobile')
...
async function buy(address, lootboxContract, usdtContract, network) {
    ...
    document.querySelector('#splash-video').addEventListener('play', () => {
        setTimeout(() => {
