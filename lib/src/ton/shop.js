...
// Was hardcoded here and, separately, in server/ton/service.js. Both values
// agreed; the registry is now the one place it lives.
const tonNetwork = findNetwork(0)
const shopAddress = tonNetwork.shopAddress
