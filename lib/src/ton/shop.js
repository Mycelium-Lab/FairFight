                                    ...
                                    messages: [
                                        {
                                            ...
                                            amount: (toNano(v.price) + toNano(0.05) * 2n).toString(), 
                                    ...
                                    let checkerInterval = setInterval(async () => {
                                        try {
                                            ...
                                            if (newItem) {
                                                ...
                                                addInventoryItem(listItemId, newItem, nftTypeName, address, 0, firstEmpty, v.address)
...
const findUniqueNewNftItem = (inventory, newInventory) => {
