...
const _shop = async (address, shopContract, characters, armors, weapons, network, signer, wrap) => {
    ...
    await createShopItem(
        ...
        usdtContract, shopContract, address, wrap, network, charactersJsons
    )
    await createShopItem(
        ...
        characterFeatureName, characterFeatureAttributes, charactersList,
        confirmModal, buyModal, pendingModal, approveModal,
        usdtContract, shopContract, address, wrap, network, armorsJsons
    )
    await createShopItem(
        ...
        characterFeatureName, characterFeatureAttributes, charactersList,
        confirmModal, buyModal, pendingModal, approveModal,
        usdtContract, shopContract, address, wrap, network, weaponsJsons
    )
}
...
const createShopItem = async (
    ...
    confirmModal, buyModal, pendingModal, approveModal,
    usdtContract, shopContract, address, wrap, network, data
) => {
