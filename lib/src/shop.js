...
const _shop = async (address, shopContract, characters, armors, weapons, boots, network, signer, wrap, isMobile) => {
    ...
    document.querySelector('#ascending-price').addEventListener('click', async () => await priceSort(_ascendingPriceSort))
    document.querySelector('#descending-price').addEventListener('click', async () => await priceSort(_descendingPriceSort))
