...
export const openFightsF2PEvm = async (fights, username, network, sign) => {
    ...
    let openGamesList = openGamesSimpleBar.querySelector('.simplebar-content')
...
const appendOpenFight = async (fight, username, network, sign) => {
    ...
    //     const encodedText = encodeURIComponent(`@${addressMaker(username)} invite you to play fairfights f2p game (id: ${addressMaker(index)})`)
