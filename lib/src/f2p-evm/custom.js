...
function openGameP2P() {
    ...
    opengames_f2p.style.display = 'none'
    pastgames_f2p.style.display = 'none'
    document.querySelector('#amountPerDeath').placeholder = document.querySelector('#totalPrizePoolToken').textContent
}
...
document.getElementById("about_game_link").onclick = () => {
    document.getElementById("about-game-modal").style.display = "block";
};
...
document.querySelector("#close-modal-window-about").onclick = e => {
    ...
    secondContent.style.display = "none";
    thirdContent.style.display = "none";
    secondButton.closest('.modal_content').classList.remove('controls-keys-page')
};
...
secondButton.onclick = () => {
    ...
    if (window.innerWidth > 1024) {
        secondButton.closest('.modal_content').classList.add('controls-keys-page')
    }
}
