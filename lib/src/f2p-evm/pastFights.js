...
export const pastFightsF2PEvm = async (pastFights, username) => {
    ...
    pastGamesBtn.addEventListener('click', () => {
        ...
        const pastGamesList = document.getElementById('pastgames-list-f2p-evm-desktop').querySelector('.simplebar-content')
        ...
        const emptyBlock = document.getElementById("pastgames_empty-f2p-evm-desktop");
    ...
    let pastGamesListBarDesktop = document.getElementById('pastgames-list-f2p-evm-desktop')
    ...
    const children = Array.from(pastGamesList.children);
    const element = isDesktop ? 'pastgames_empty-f2p-evm-desktop' : "pastgames_empty-f2p-evm";
    const exmptyBlock = document.getElementById(element);
    
    if (children.length === 1) {        
        exmptyBlock.style.display = '';
        ...
        exmptyBlock.style.display = 'none';
