...
export const pastFightsF2PEvm = async (pastFights, username) => {
    ...
    let pastGamesList = isDesktop ? document.querySelector('#pastgames-list-f2p-evm-desktop') : pastGamesListBar.querySelector('.simplebar-content')
    if(isInfoModal) {
...
export const addToPastFights = async (fight, username, isInfoModal, from) => {
    ...
    let pastGamesList = isDesktop ? document.querySelector('#pastgames-list-f2p-evm-desktop') : document.getElementById('pastgames-list-f2p-evm').querySelector('.simplebar-content')
