...
const inventoryModal = async (address, network, signer, inventory, charactersContract, armorsContract, bootsContract, weaponsContract) => {
    ...
    charactersHave.forEach((v, i) => {
        try {
            addInventoryItem("#left-inventory-characters-list", v, InventoryTypes.CHARACTERS, address, network, i)
        } catch (error) {
            console.log(error)
        }
    })
    ...
    weaponsHave.forEach((v, i) => {
        try {
            addInventoryItem("#left-inventory-weapons-list", v, InventoryTypes.WEAPONS, address, network, i)
        } catch (error) {
            console.log(error)
        }
    })
    ...
    armorHave.forEach((v, i) => {
        try {
            addInventoryItem("#left-inventory-armors-list", v, InventoryTypes.ARMORS, address, network, i)
        } catch (error) {
            console.log(error)
        }
    })
    ...
    bootsHave.forEach((v, i) => {
        try {
            addInventoryItem("#left-inventory-boots-list", v, InventoryTypes.BOOTS, address, network, i)
        } catch (error) {
            console.log(error)
        }
    })
...
const showInventoryItemModal = async (
    ...
    if (itemType === InventoryTypes.WEAPONS) {
        ...
        if (elementToCheckCurrent.firstChild && elementToCheckCurrent.firstChild.src) {
