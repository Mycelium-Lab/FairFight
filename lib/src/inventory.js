    ...
    for (let i = 0; i < charactersIds.length; i++) {
        try {
            ...
            if (characterBought != 0) {
                ...
                addInventoryItem("#left-inventory-characters-list", character, InventoryTypes.CHARACTERS, address, network, i+1, inventory.characterid)
            }                      
        } catch (error) {
            console.log(error)
        }
    ...
    for (let i = 0; i < armorsJsons.length; i++) {
        try {
            ...
            if (bought != 0) {
                ...
                addInventoryItem("#left-inventory-armors-list", armor, InventoryTypes.ARMORS, address, network, i, inventory.armor)
            }
        } catch (error) {
            console.log(error)
        }
    ...
    for (let i = 0; i < bootsJsons.length; i++) {
        try {
            ...
            if (bought != 0) {
                ...
                addInventoryItem("#left-inventory-boots-list", boots, InventoryTypes.BOOTS, address, network, i, inventory.boots)
            }
        } catch (error) {
            console.log(error)
        }
    ...
    for (let i = 0; i < weaponsJsons.length; i++) {
        try {
            ...
            if (bought != 0) {
                ...
                addInventoryItem("#left-inventory-weapons-list", weapon, InventoryTypes.WEAPONS, address, network, i, inventory.weapon)
            }
        } catch (error) {
            console.log(error)
        }
