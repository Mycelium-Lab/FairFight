...
export const addInventoryItem = (itemListId, item, itemType, address, network, i, settedId, _height, _width) => {
    ...
    if (!list.item(i)) {
        ...
        _slot.classList.add('item-list__slot')
            ...
            corner1Image.src = 'media/svg/inventory/bronze-edge-slot.svg'
            corner2Image.src = 'media/svg/inventory/bronze-edge-slot.svg'
            corner3Image.src = 'media/svg/inventory/bronze-edge-slot.svg'
            corner4Image.src = 'media/svg/inventory/bronze-edge-slot.svg'
    ...
    img.onload = function () {
        ...
        function animateFrames() {
            ...
            ctx.drawImage(
                ...
                -45, // X-координата отрисовки на canvas
