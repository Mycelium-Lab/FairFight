            ...
            if (
                ...
                fetch('/balance?' + querySign.toString())
                    .then(async (res) => {
                        ...
                        internalBalance.textContent = `${data == null ? ethers.utils.formatEther(battle.player1Amount.toString()) : ethers.utils.formatEther(data.toString())} `
                    })
                ...
                fetch('/balance?' + querySignEnemy.toString())
                    .then(async (res) => {
                        ...
                        const data = await res.json()
                        enemyBalance.textContent = `${data == null ? ethers.utils.formatEther(battle.player1Amount.toString()) : ethers.utils.formatEther(data.toString())} `
                    })
