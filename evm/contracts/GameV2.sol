...
//     function createBattle(uint256 amountForOneDeath, uint8 numberOfPlayers) external payable whenNotPaused {
...
//         require(numberOfPlayers <= maxAmountNumberOfPlayers, "Too much players");
//         uint256 battlesLength = battles.length;
//         Battle memory _newBattle = Battle(
//             battlesLength,   //ID
//             msg.sender,      //owner
//             new address[](numberOfPlayers),      //players
//             address(0),      //winner
//             msg.value,       //player1Amount
//             new uint256[](numberOfPlayers),      //playersAmount
//             false,           //finished
...
//         require(msg.value == _battle.ownerAmount, "Not enough amount to play");
//         require(_battle.owner != address(0), "Battle not exists");
//         require(_battle.finished == false, "Battle already finished");
//         require(_battle.owner != msg.sender, "You creator of this battle");
//         require(currentlyBusy[msg.sender] == false, "You already have open battle");
//         battles[_ID].players.push(msg.sender);
//         battles[_ID].playersAmount.push(msg.value);
//         currentlyBusy[msg.sender] = true;
//         userBattles[msg.sender]+=1;
//         battles[_ID] = _battle;
...
//         require(_battle.owner == msg.sender, "You not creator");
//         for (uint8 i = 0; i < _battle.numberOfPlayers; i++) {
//             if (_battle.players[i] != address(0)) {
//                 revert("Battle was joined");
//             }
//         }
...
//         (bool success, ) = msg.sender.call{value: _battle.ownerAmount}("");
//         battles[ID] = _battle;
...
//         require(checkAccess(_ID, playerAmount, _r, _v, _s), "You dont have access");
//         Battle memory _battle = battles[_ID];
...
//             }
//         }
//         Battle memory _battle = Battle(0,address(0),address(0),address(0),0,0,false,0,0,0,0);
//         return _battle;
//     }
